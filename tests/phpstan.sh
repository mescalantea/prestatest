#!/bin/bash
PS_VERSION=${SQ_PRESTASHOP_VERSION:-latest}
...
docker exec -t temp-ps rm -rf /var/www/html/modules/sequra
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/sequra \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/sequra phpstan/phpstan \
       analyse \
       --configuration=/var/www/html/modules/sequra/tests/phpstan/phpstan-$PS_VERSION.neon
